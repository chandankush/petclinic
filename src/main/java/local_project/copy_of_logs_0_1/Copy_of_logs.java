package local_project.copy_of_logs_0_1;
...
/**
 * Job: Copy_of_logs Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.5.1.20180116_1512
 * @status 
 */
public class Copy_of_logs implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_logs.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(Copy_of_logs.class);
	...
	private final String jobName = "Copy_of_logs";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_logs.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Copy_of_logs = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Copy_of_logs = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Copy_of_logs.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_Copy_of_logs.length == 0) {
						commonByteArray_LOCAL_PROJECT_Copy_of_logs = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Copy_of_logs = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Copy_of_logs, 0,
						length);
				strReturn = new String(
						commonByteArray_LOCAL_PROJECT_Copy_of_logs, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Copy_of_logs) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (dbschema_tMSSqlOutput_1 == null
					...
					tableName_tMSSqlOutput_1 = "tcatcher";
				} else {
				...
				class BytesLimit65535_tLogCatcher_1 {
					public void limitLog4jByte() throws Exception {
						...
						log4jParamters_tLogCatcher_1
								.append("CATCH_JAVA_EXCEPTION" + " = " + "true");
				...
				for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
					...
					if (row3.root_pid == null) {
						...
						pstmt_tMSSqlOutput_1.setString(3, row3.root_pid);
					}

					if (row3.father_pid == null) {
						pstmt_tMSSqlOutput_1.setNull(4, java.sql.Types.VARCHAR);
					} else {
						pstmt_tMSSqlOutput_1.setString(4, row3.father_pid);
					}

					if (row3.project == null) {
						pstmt_tMSSqlOutput_1.setNull(5, java.sql.Types.VARCHAR);
					} else {
						pstmt_tMSSqlOutput_1.setString(5, row3.project);
					}

					if (row3.job == null) {
						pstmt_tMSSqlOutput_1.setNull(6, java.sql.Types.VARCHAR);
					} else {
						pstmt_tMSSqlOutput_1.setString(6, row3.job);
					}

					if (row3.context == null) {
						pstmt_tMSSqlOutput_1.setNull(7, java.sql.Types.VARCHAR);
					} else {
						pstmt_tMSSqlOutput_1.setString(7, row3.context);
					}

					if (row3.priority == null) {
						pstmt_tMSSqlOutput_1.setNull(8, java.sql.Types.INTEGER);
					} else {
						pstmt_tMSSqlOutput_1.setInt(8, row3.priority);
					}

					if (row3.type == null) {
						pstmt_tMSSqlOutput_1.setNull(9, java.sql.Types.VARCHAR);
					} else {
						pstmt_tMSSqlOutput_1.setString(9, row3.type);
					}
					...
					if (row3.origin == null) {
						...
						pstmt_tMSSqlOutput_1.setString(10, row3.origin);
					}
					...
					if (row3.message == null) {
						...
						pstmt_tMSSqlOutput_1.setString(11, row3.message);
					}
					...
					if (row3.code == null) {
						...
						pstmt_tMSSqlOutput_1.setInt(12, row3.code);
					}
				...
				class BytesLimit65535_tFileOutputDelimited_1 {
					public void limitLog4jByte() throws Exception {
						...
						log4jParamters_tFileOutputDelimited_1
								.append("FILENAME"
										+ " = "
										+ "\"C:/Users/Grad/Desktop/Intsallables/Talend-Tools-Studio/Talend-Tools-Studio-20180116_1512-V6.5.1/workspace/out.csv\"");
						log4jParamters_tFileOutputDelimited_1.append(" | ");
						log4jParamters_tFileOutputDelimited_1
	...
	public static void main(String[] args) {
		final Copy_of_logs Copy_of_logsClass = new Copy_of_logs();

		int exitCode = Copy_of_logsClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_logs' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_logs' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_logs.class.getClassLoader()
					.getResourceAsStream(
							"local_project/copy_of_logs_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_logs");
		}
...
/************************************************************************************************
 * 147432 characters generated by Talend Data Integration on the August 14, 2018
 * 4:40:38 PM IST
 ************************************************************************************************/
